...
import { Plus, Filter } from "lucide-react"; // Using Plus for the Add Category button
    ...
    for (let i = 1; i <= totalPages; i++) {
      ...
      if (
        ...
        !(
          ...
          typeof (pages[pages.length - 1] as any)?.props?.children ===
            "string" &&
